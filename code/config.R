...
f_load_packages <- function(packages) {
  # load all packages, whether newly installed or not
  for (pkg in packages) {
    library(pkg, character.only = TRUE, quietly = TRUE)
  }
...
#                             "openxlsx","readxl","lubridate","plotly","here","kableExtra","scales","ggrepel",
#                             "DT","AMR","ggpubr","sf","tmap","htmltools","formattable","here"))
f_load_packages(c("dplyr","tidyr", "stringr","forcats","xfun","htmltools",
                              "openxlsx","readxl","lubridate","plotly","here","kableExtra","scales","ggrepel",
                              "DT","AMR","ggpubr","sf","tmap","htmltools","formattable","here"))
